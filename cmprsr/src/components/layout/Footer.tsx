...
export default function Footer(): ReactElement {
	return (
		<footer className='footer flex flex-wrap items-center justify-between bg-neutral p-4 text-neutral-content'>
			<div className='flex w-fit items-center'>
				...
				<button type='button' onClick={(): void => klaro.show(undefined, true)}>
					<svg
						width='36'
						height='36'
						viewBox='0 0 24 24'
